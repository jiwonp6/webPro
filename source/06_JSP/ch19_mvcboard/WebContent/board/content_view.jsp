...
<body>
	<table>
		...
		<tr>
			<th>글번호</th><td>${content_view.bid }</td>
		</tr>
		<tr>
			<th>작성자</th><td>${content_view.bname }</td>
		</tr>
		<tr>
			<th>제목</th><td>${content_view.btitle }</td>
		</tr>
		<tr>
			<th>본문</th><td><pre>${content_view.bcontent }</pre></td>
		</tr>
		<tr>
			<th>작성일</th><td><fmt:formatDate value="${content_view.bdate }" pattern="yy/MM/dd(E)" /></td>
		</tr>
		<tr>
			<th>IP</th><td>${content_view.bip }</td>
		</tr>
		<tr>
			<th>조회수</th><td>${content_view.bhit }</td>
		</tr>
		<tr>
			<td colspan="2">
