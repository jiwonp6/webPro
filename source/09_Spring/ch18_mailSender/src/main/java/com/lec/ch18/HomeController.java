...
public class HomeController {
	...
	public String textMail(String name, String email, Model model) {
		//name에게 email주소로 textMail 보내기
		SimpleMailMessage message = new SimpleMailMessage();
		message.setFrom("park65758636@gmail.com");	//관리자 메일 주소(보내는 사람 메일)
		message.setTo(email);//받는사람메일
	...
	public String htmlMail(final String name, final String email, Model model) {
		...
		MimeMessagePreparator message = new MimeMessagePreparator() {	//추상메소드라 new로 바로 객체생성X
			String content="<div style=\"width: 500px; margin: 0 auto;\">\n" + 
					"	<h1 style=\"color: blue; font-size: 1.5em;\">"+name+"님 회원가입 감사합니다</h1>\n" + 
					"	<div>\n" + 
					"		<p>아무개 사이트에서만 쓰실 수 있는 감사쿠폰을 드립니다.</p>\n" + 
					"		<p>\n" + 
					"			<img alt=\"coupon\" src=\"http://localhost:8090/ch18/resources/coupon.jpg\">\n" + 
					"		</p>\n" + 
					"	</div>\n" + 
					"	<div>\n" + 
